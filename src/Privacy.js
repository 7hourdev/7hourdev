        ...
        <div className="container ">
          <div className="row about-page">
            <div className="col-md-10 col-md-offset-1">
              <h1>7hourdev.com Privacy Policy</h1>
              <div>
                <div class="innerText">
                  ...
                  handle your Personally Identifiable Information in accordance with our website.<br />
                </div>
                <span id="infoCo" />
                <br />
                <div class="grayText">
                ...
                <div class="innerText">
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> To administer a contest, promotion, survey or
                  other site feature.
                </div>
                <span id="infoPro" />
                <br />
                ...
                <div class="innerText">
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> We only provide articles and information. We
                  never ask for personal or private information like names, email addresses, or credit card numbers.
                </div>
                <span id="coUs" />
                <br />
                <div class="grayText">
                ...
                <div class="innerText">
                  <br />You can choose to have your computer warn you each time a cookie is being sent, or you can
                ...
                <div class="innerText">
                  ...
                  partners and other parties who assist us in operating our website, conducting our business, or serving
                  our users, so long as those parties agree to keep this information confidential. We may also release
                  information when it's release is appropriate to comply with the law, enforce our site policies, or
                  protect ours or others' rights, property or safety. <br /> However, non-personally identifiable
                ...
                <div class="innerText">
                  <br />Google, as a third-party vendor, uses cookies to serve ads on our site. Google's use of the DART
                ...
                <div class="innerText">
                  ...
                  first significant page after entering our website.<br />
                </div>
                <div class="innerText">
                ...
                <div class="innerText">
                  ...
                  operators of websites and online services must do to protect children's privacy and safety online.<br />
                </div>
                ...
                <div class="innerText">
                  ...
                  implemented is critical to comply with the various privacy laws that protect personal information.<br />
                </div>
                <div class="innerText">
                  <strong>
                ...
                <div class="innerText">
                  <br />We also agree to the Individual Redress Principle which requires that individuals have the right
                  to legally pursue enforceable rights against data collectors and processors who fail to adhere to the
              ...
              <div class="innerText">7hourdev.com</div>
              <div class="innerText">7hourdev@gmail.com</div>
              <div class="innerText">
                <br />Last Edited on 2016-09-21
              </div>
            </div>
          </div>
        </div>
